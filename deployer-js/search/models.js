...
// the date suffix.
export const INDEX_ALIAS_NAME = "mdn_docs";
...
const dex_word_delimiter = Object.freeze({
  type: "word_delimiter",
...
const custom_stopwords = Object.freeze({
  type: "stop",
  ignore_case: true,
...
const keep_html_char_filter = Object.freeze({
...
const special_charater_name_char_filter = Object.freeze({
  type: "pattern_replace",
...
const unicorns_char_filter = Object.freeze({
  type: "mapping",
  mappings: [
...
const text_analyzer = Object.freeze({
  type: "custom",
  tokenizer: "standard",
...
/** @type {import("@elastic/elasticsearch/lib/api/types").IndicesIndexSettings} */
...
export function indexName() {
  return `${INDEX_ALIAS_NAME}_${Date.now()}`;
}
