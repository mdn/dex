...
| `npm run install:all`     | Runs `yarn install` in all subdirectories with `yarn.lock`                      |
| `npm run install:all:npm` | Runs `npm install` in all subdirectories with `package-lock.json`               |
